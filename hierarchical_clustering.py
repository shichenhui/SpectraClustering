...
# eg. python3 spectra_clustering.py index_AFGK_1kx4.csv 4 5 0 1000
# eg. python3 spectra_clustering.py index_AFGK_1kx4.csv 4 5 0 1000 1000 1000 1000
#
...
print('run model... ')
model = AgglomerativeClustering(n_clusters=setting_class_num, affinity='euclidean', linkage='ward')
